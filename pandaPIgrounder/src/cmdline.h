...
struct gengetopt_args_info
{
  ...
  char * plan_arg;	/**< @brief specify a plan. One the methods pertaining to this plan will be grounded. Provide a file(name) in which the plan is..  */
  char * plan_orig;	/**< @brief specify a plan. One the methods pertaining to this plan will be grounded. Provide a file(name) in which the plan is. original value given at command line.  */
  const char *plan_help; /**< @brief specify a plan. One the methods pertaining to this plan will be grounded. Provide a file(name) in which the plan is. help description.  */
  ...
  int keep_two_regularisation_flag;	/**< @brief keep two regularisation if it is already present in the input domain (default=off).  */
  const char *keep_two_regularisation_help; /**< @brief keep two regularisation if it is already present in the input domain help description.  */
  int compactify_actions_flag;	/**< @brief combine consecutive primitive actions in methods into one. (default=off).  */
  const char *compactify_actions_help; /**< @brief combine consecutive primitive actions in methods into one. help description.  */
  ...
  unsigned int keep_two_regularisation_given ;	/**< @brief Whether keep-two-regularisation was given.  */
  unsigned int compactify_actions_given ;	/**< @brief Whether compactify-actions was given.  */
